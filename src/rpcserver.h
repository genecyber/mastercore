...
extern json_spirit::Value getMPbalance(const json_spirit::Array& params, bool fHelp); // in mastercoin.cpp
extern json_spirit::Value sendMPsimple(const json_spirit::Array& params, bool fHelp); // in mastercoin.cpp
